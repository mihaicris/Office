		...
		<table class="persoane">
			...
			<tr>
				<td>
					...
					<input class="normal mediu" id="nume_persoana" type="text" name="nume_persoana" autocomplete="off"/>
				</td>
				<td>
					<label for="prenume_persoana">Prenume</label><br/>
					<input class="normal mediu" id="prenume_persoana" type="text" name="prenume_persoana" autocomplete="off"/>
				</td>
				<td></td>
			</tr>
			<tr>
				...
				<td>
					...
					<input class="normal mediu" id="fax_persoana" type="text" name="fax_persoana" autocomplete="off"/>
				</td>
				<td></td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					...
					<input class="normal mediu" id="dep_persoana" type="text" name="dep_persoana" autocomplete="off"/>
				</td>
				<td>
					<label for="functie_persoana">Funcție</label><br/>
					<input class="normal mediu" id="functie_persoana" type="text" name="functie_persoana" autocomplete="off"/>
				</td>
				<td></td>
			</tr>
			</tbody>
